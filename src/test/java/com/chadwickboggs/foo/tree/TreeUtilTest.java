...
public class TreeUtilTest {
    ...
    private void verifyTree( final Node node, final List< String > nulls, final List< String > notNulls ) {
        ...
        String message =
                String.format( "Node.value does not match expected node.value.  Value: %s", node.getValue() );
        assertEquals( message, 6, node.getValue() );

        assertNotNull( "Null node.left.", node.getLeft() );
        message = String.format( "Node.left.value does not match expected node.left.value.  Value: %s", node.getLeft().getValue() );
        ...
        message = String.format(
                "Node.left.right.value does not match expected node.left.right.value.  Value: %s", node.getLeft().getRight().getValue() );
        ...
        message = String.format(
                "Node.right.value does not match expected node.right.value.  Value: %s", node.getRight().getValue() );
        ...
        message = String.format(
                "Node.right.right.value does not match expected node.right.right.value.  Value: %s", node.getRight().getRight().getValue() );
